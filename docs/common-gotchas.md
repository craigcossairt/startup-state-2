...
| Fixture-1 trips the honest-no floor | Keyword `SBIR healthcare AI nurses` returned embassy AI grants, not SBIR. Rank then had no federal likely / potential-verify | Drop `U.S. Mission to` rows. Recache fixture-1 SBIR as `SBIR STTR healthcare`. Tell rank same-sector NIH/NSF/HHS/SBIR is at least potential-verify | 2026-08-15 | judged path |
