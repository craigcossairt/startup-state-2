...
| FAB covered footer copy on a tall page, or jumped on a short one | Part 2 docked whenever the footer was visible and used `#site-footer` only | `dockFabAboveFooter` ports Part 1: last footer, short vs tall, clamp to half the viewport | 2026-08-15 | ask panel |
