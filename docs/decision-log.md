...
- **2026-08-14** - Retrieve is per-source adapters, ~50 IDs then 8–12 ranked cards, GOEO keys fire from profile rules, probably-not floor when federal is weak. Draft: `docs/spec/retrieve-and-rank.md`. See [Retrieve and probably-not floor](https://github.com/craigcossairt/startup-state-2/issues/2).
