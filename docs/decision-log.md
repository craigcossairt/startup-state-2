...
- **2026-08-14** - Locked Company profile schema (`docs/spec/company-profile-schema.md`). See [Company profile schema](https://github.com/craigcossairt/startup-state-2/issues/8).
