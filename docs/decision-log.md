...
- **2026-08-14** - Company profile schema is draft only; round 1 grilling locked field categories; types/enums/fixtures pending HITL rounds 2+. See [Company profile schema](https://github.com/craigcossairt/startup-state-2/issues/8). Supersedes premature 2026-08-14 lock entry.
