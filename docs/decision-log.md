...
- **2026-08-13** - Infer and rank use Anthropic Haiku 4.5 via Vercel AI SDK on the Part 1 key. Rank may only emit retrieved IDs. See [Infer and rank provider](https://github.com/craigcossairt/startup-state-2/issues/5).
